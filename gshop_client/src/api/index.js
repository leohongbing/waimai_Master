...
export const reqFoodsCategories = ()=> ajax(base_url+'/index_category')
...
// [6、用户名密码登陆](#6用户名密码登陆)
export const reqCaptchaLogin = ({name,pwd,captcha})=> ajax(base_url+'/login_pwd',{name,pwd,captcha},'POST')
