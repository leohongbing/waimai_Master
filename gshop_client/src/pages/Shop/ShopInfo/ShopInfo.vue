  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" v-for="(support,index) in info.supports" :key="index" :class="activityClass[support.type]">
  ...
  export default {
    ...
    methods:{
      _initDate(){
        ...
        //获取li的宽度 个数 设置ul宽度
        const picList = this.$refs.picList
        const length = this.info.pics.length
        picList.style.width = (126 * length - 6) + 'px'
